Эта программа (Windows Service) исполняет обмен данными между многочисленными PLC и компьютером, используя много потоков. Каждый поток работает с одним PLC.
