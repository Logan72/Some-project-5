...
namespace ClassLibrary.Sever_connection.Mitsubishi_PLC
{
    ...
    public interface IPlc : IDisposable
    {
        ...
        //Task<byte[]> ReadDeviceBlock(string iDeviceName, int iSize, int[] oData, int iValueNumber);
        //Task<byte[]> ReadDeviceBlock(PlcDeviceType iType, int iAddress, int iSize, int[] oData, int iValueNumber);
